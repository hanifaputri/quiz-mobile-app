...
public class Question4Activity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    Button btnNext;
    RadioGroup options;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        options = (RadioGroup) findViewById(R.id.rg_answers_4);
        btnNext = (Button) findViewById(R.id.btn_next_4);
...
//                    Toast.makeText(getApplicationContext(), "Curr Score " + currScore, Toast.LENGTH_SHORT).show();
                    ...
                    Log.d("#4 - Current Score", "" + currScore);
    ...
    public void onCheckedChanged(RadioGroup options, int checkedId){
        switch (checkedId){
            case R.id.rg_answers_4_1:
                wrong();
                break;
            case R.id.rg_answers_4_2:
                wrong();
                break;
            case R.id.rg_answers_4_3:
                right();
                break;
        }
    }
