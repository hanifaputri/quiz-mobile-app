...
public class Question5Activity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    Button btnNext;
    RadioGroup options;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        options = (RadioGroup) findViewById(R.id.rg_answers_5);
        btnNext = (Button) findViewById(R.id.btn_next_5);
...
//                    Toast.makeText(getApplicationContext(), "Curr Score " + currScore, Toast.LENGTH_SHORT).show();
                    ...
                    Log.d("#5 - Current Score", "" + currScore);
    ...
    public void onCheckedChanged(RadioGroup options, int checkedId){
        switch (checkedId){
            case R.id.rg_answers_5_1:
                right();
                break;
            case R.id.rg_answers_5_2:
                wrong();
                break;
            case R.id.rg_answers_5_3:
                wrong();
                break;
        }
    }
